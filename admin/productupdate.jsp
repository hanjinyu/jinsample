    ...
    <body>
        ...
        <div class="inputArea"> 
         <label>카테고리</label>
 			<select class="category" name="cateCode">
 			 <option value="cateCode">전체</option>
 		</select>
		</div>
		<div class="inputArea">
 			<label for="productName">상품명</label>
 			<input type="text" id="productName" name="productName" value="${productvo.productName}"/>
		</div>
		...
		<div class="inputArea">
			 ...
			 $("#back_Btn").click(function(){
 			 //history.back();
			 location.href = "/admin/productView?n=" + ${productvo.productId};
			 });   
			</script>
		</div>
