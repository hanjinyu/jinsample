...
<%-- 		<caption>Optical Sensor</caption> --%>
		 ...
		 <tbody>
			  <c:forEach items="${ledmain}" var="ledmain">
			  <tr width="200px" height="100px">
			  	  <td width="200px" height="100px">
			  	  <div class="ledThumb">
			  	  	<img src="${ledmain.productThumbImg}">
			  	  </div>
			  	  </td>
 				  <td>
 				  <a href="/product/view?n=${ledmain.productId}">${ledmain.productName}</a>
 				  </td>
				  <td>${ledmain.productIntro}</td>
 				  <td>${ledmain.productPrice}</td>
 				  <td>${ledmain.productStock}</td>
			  </tr>
			 </c:forEach>
 </tbody>
</table>
