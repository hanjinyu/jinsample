...
<span data-testid="filter--4-option-818"Onclick="location.href='/product/opticalsensorlist?c=110&s=111&p=100'">Digital</span></span>
...
<span data-testid="filter--4-option-0" Onclick="location.href='/product/opticalsensorlist?c=120&s=121&p=100'">Analog</span></span>
...
<span data-testid="filter--4-option-91606"Onclick="location.href='/product/opticalsensorlist?c=100&s=110&p=100'"></span></span>
...
<span data-testid="filter--5-option-8" Onclick="location.href='/product/opticalsensorlist?c=110&s=111&p=100'">Slotted</span></span>
...
<span data-testid="filter--5-option-243" Onclick="location.href='/product/opticalsensorlist?c=110&s=111&p=100'">Separated</span></span>

</div></div></div></fieldset></div></div></div></div>

<div class="Category-root Category-item jss107">
<div class="jss103">
<div class="jss106">패키지</div>
<div class="jss105">
<div tabindex="0" class="jss108" data-testid="filter-box-outer-ref">
<fieldset class="MuiFormControl-root">
<div class="MuiFormGroup-root" data-testid="filter-box-group--5">
...
<div tabindex="0" data-testid="filter-box-inner-ref" style="height: 100px; width: 100%; outline: none;">
<span class="jss109" title="-" data-testid="filter--5-label-8" data-index="0" data-focused="false" data-filter-key="-5" data-filter-value="8" data-radio="false" data-common="false" data-disabled="false" style="position: absolute; left: 0px; top: 0px; height: 20px; width: 100%;">
<span data-testid="filter--5-option-8">Wired</span></span>
<span class="jss109" title="Digi-Reel®" data-testid="filter--5-label-243" data-index="1" data-focused="false" data-filter-key="-5" data-filter-value="243" data-radio="false" data-common="false" data-disabled="false" style="position: absolute; left: 0px; top: 20px; height: 20px; width: 100%;">
<span data-testid="filter--5-option-243">Mon-Wired</span></span>
...
<span data-testid="filter--5-option-61">Connector</span></span>
...
<%-- 		<caption>Optical Sensor</caption> --%>
		 ...
		 <tbody>
			  <c:forEach items="${opticalmain}" var="opticalmain">
			  <tr width="200px" height="100px">
			  	  <td width="200px" height="100px">
			  	  <div class="opticalThumb">
			  	  	<img src="${opticalmain.productThumbImg}">
			  	  </div>
			  	  </td>
 				  <td>
 				  <a href="/product/view?n=${opticalmain.productId}">${opticalmain.productName}</a>
 				  </td>
				  <td>${opticalmain.productIntro}</td>
 				  <td>${opticalmain.productPrice}</td>
 				  <td>${opticalmain.productStock}</td>
			  </tr>
			 </c:forEach>
 </tbody>
</table>
