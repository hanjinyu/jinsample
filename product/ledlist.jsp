...
<div tabindex="0" data-testid="filter-box-inner-ref" style="height: 50px; width: 100%; outline: none;">
...
<span data-testid="filter--4-option-818"Onclick="location.href='/product/opticalsensorlist?c=210&s=211&p=200'">Digital</span></span>
...
<span data-testid="filter--4-option-0" Onclick="location.href='/product/opticalsensorlist?c=220&s=221&p=200'">Analog</span></span>
...
<span data-testid="filter--4-option-91606"Onclick="location.href='/product/opticalsensorlist?c=200&s=210&p=200'"></span></span>
...
<%-- 		<caption>Optical Sensor</caption> --%>
		 ...
		 <tbody>
			  ...
			  <tr width="200px" height="100px">
				  ...
				  <td>${productlist.productIntro}</td>
